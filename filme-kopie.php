...
$mysqli = new mysqli('localhost', 'matthias', 'seppel', 'filmsammlung'); // das muss in externe include Datei!!
...
$erg = $mysqli->query("SELECT id, dateiname, pfad, typ, name FROM filme order by dateiname")
	or die($mysqli->error);

// hier wird das Array initialisiert   ?? wofür das array ??
/*$ergebnis= array();
$ergebnis[] = array("ID"=>"0",
					"Name"=>"Film-Name",
					"Pfad"=>"NAS/Filme/Test-Film",
					"Datei"=>"Datei-Name",
					"Typ"=>"Test-Typ",
					"Genre"=>"Thriller");
*/
