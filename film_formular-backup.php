...
<tr></tr>
<tr>
 <td><input type="Submit" name="" formaction="film_speichern.php" value="übernehmen"></td>
...
<div class="genre">
	<table>
	<tr>
	<td><input type="checkbox" name="Serie" value="Serie " <?php if (stripos($zeile->genre, "serie")!==false){ echo " checked"; } ?>>Serie</td>
	</tr>
...
<form target="_blank" action="https://google.de/search">
	...
	<td><label>	<input name="q" value="<?php echo "filmstarts " . $zeile->name ?>"></label></td>
</form>
</table>
