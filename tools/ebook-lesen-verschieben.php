            ...
            if (is_dir("$dir/$file")) {
                ...
                if ($zip->open($name) === true) {
                    ...
                    if ($rootfiles->length > 0) {
                        ...
                        // wenn kein author und kein titel
                        if ($title == "") {
                        ...
                        if (!is_dir("$zielverzeichnis/$zielordner")) {      / wenn der Zielordner nicht vorhanden ist
                        ...
                        if (file_exists($zielpfad)) {
                            ...
                            if (@unlink($quellpfad) == true) {      // unlink löscht die datei
                                /*
                        ...
                        if (file_exists($quellpfad)) {
                            if (rename($quellpfad, $zielpfad)) {        // mit rename wird die datei umbenannt und verschoben
                            ...
                            $result = $erg->execute();
                                while ($auth = $erg->fetch()) {
                                    ...
                                    if ($author == $auth['name']) {
                                        ...
                                        //echo ' ID: ' . $id_author;
                                        //echo '<br>';
                                        break; // Author wurde gefunden => Schleife beenden
                                    }
                                } //test                          
                                // der author ist noch nicht in der Tabelle tab_author => der neue author wird eingefügt
                                if ($id_author == -1) {
