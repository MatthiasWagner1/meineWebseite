...
<br><br>
<form>
  <input id = "buttons_suche" type="Submit" name="" formaction="ebook.php?ID=1" value="eBooks">
  <input id = "buttons_suche" type="Submit" name="" formaction="ebook_autor.php?ID=2" value="Autoren">
</form>
<br><br>
...
*/
 ...
 function ausgabe($erg)
 {
  ...
  //echo 	'<thead><tr><td>ID</td><td>Autor</td><td>Titel</td></tr></thead>';
    ...
    echo '<td><a href=ebook_formular.php?ID='.$id.'>'. $data['name'] . '</a></td>';
