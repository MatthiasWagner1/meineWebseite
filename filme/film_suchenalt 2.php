...
<main>    
 <h1>Filme </h1>
  ...
  <input type="Submit" name="" formaction="film_suchen_in.php?i=1" value="finden in Genre">
  <input type="Submit" name="" formaction="film_suchen_in.php?i=2" value="finden in Beschreibung">
  <br>
...
$erg = $mysqli->query("SELECT id, dateiname, pfad, typ, name, genre, bewertung, beschreibung FROM filme order by name")
	or die($mysqli->error);
