<?php
try {
    $server = "mysql:host=localhost;dbname=ebooks;charset=utf8mb4";
    $user = "matthias";
    $password = "seppel";
...
$server   = 'mysql:dbname=ebooks;host=localhost; port=3333';
$user     = 'matthias';
$password = 'seppel';
$options  = array
            (
...
$pdo      = new PDO($server, $user, $password, $options);
$pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION); // Fehler als Exception werfen
