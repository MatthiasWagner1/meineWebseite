...
<br>
<table>
<td></td><td><input type="Submit" name="" formaction="dinge_formular_ort.php" value="Ort ändern"></td>
<tr><td>Ort:</td><td><input type="text" name="name_ort" value="<?php echo $zeile->name_ort ?>" size="20" maxlength="20" readonly></td></tr>

<!--
hier wird die ID der ort (des Ortes) versteckt übertragen mit dem namen fs_ort der beim speichern
benötigt wird
-->
<tr hidden><td>ort:</td><td><input type="text" name="fs_ort" value="<?php echo $zeile->fs_ort ?>" size="20" maxlength="20"></td></tr>
...
<tr><td>Beschr. Ort:</td><td><input type="text" name="stockwerk" value="<?php echo $zeile->beschreibung_ort ?>" size="35" maxlength="20"  readonly></td></tr>
