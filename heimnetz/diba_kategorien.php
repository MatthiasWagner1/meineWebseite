 ...
 // ====================== Kategorien zuordnen ========================================
  ...
  // Treibstoff
   ...
   foreach ($suchwort as $word) {
	...
	// Haus
	$suchwort = array("gemeinde", "landkreis", "n-ergie", "google", "fraenk", "mobil", "m-net", "heimwerk", "verein", "bundeskasse", "powwow", "einfach", "ringer"); 
...
// Einnahmen
// $suchwort = array("rente", "diepersdorf", "bargeld", "amt", "helene", "", ""); 
$suchwort = array("rente", "diepersdorf", "bargeld", "amt", "helene"); 
foreach ($suchwort as $word) {
	if (stripos($empfang, $word) !== false) {  // stripos statt strpos = klein- grossschreibung egal
		$kategorie = "Einnahmen";
